...
class PETRTransformerEncoder(TransformerLayerSequence):
    ...
    Args:
        post_norm_cfg (dict): Config of last normalization layer. Default锛?            `LN`. Only used when `self.pre_norm` is `True`
    """
...
class PETRTransformerDecoder(TransformerLayerSequence):
    ...
    Args:
        ...
        post_norm_cfg (dict): Config of last normalization layer. Default锛?            `LN`.
    """
