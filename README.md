...
[馃摌Documentation](https://mmdetection3d.readthedocs.io/en/latest/) |
[馃洜锔廔nstallation](https://mmdetection3d.readthedocs.io/en/latest/get_started.html) |
[馃憖Model Zoo](https://mmdetection3d.readthedocs.io/en/latest/model_zoo.html) |
[馃啎Update News](https://mmdetection3d.readthedocs.io/en/latest/notes/changelog.html) |
[馃殌Ongoing Projects](https://github.com/open-mmlab/mmdetection3d/projects) |
[馃Reporting Issues](https://github.com/open-mmlab/mmdetection3d/issues/new/choose)
...
- **High efficiency**
  ...
  It trains faster than other codebases. The main results are as below. Details can be found in [benchmark.md](./docs/en/notes/benchmarks.md). We compare the number of samples trained per second (the higher, the better). The models that are not supported by other codebases are marked by `鉁梎.
...
**v1.4.0** was released in 8/1/2024锛?
