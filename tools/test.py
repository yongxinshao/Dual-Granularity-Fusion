...
# <local-path>/point_code/mmdetection3d-main/configs/pv_rcnn/pv_rcnn_org_test_car.py
# <local-path>/point_code/mmdetection3d-main/configs/pv_rcnn/pv_rcnn12.py
# ../configs/mvxnet/points_voxel_fusion_cc.py 1493 898  32953 712 32953 0 0 32953
# TODO: support fuse_conv_bn and format_only
def parse_args():
    parser = argparse.ArgumentParser(
        description='MMDet3D test (and eval) a model')
    parser.add_argument('--config', help='test config file path',
                        default='../configs/mvxnet/points_voxel_fusion_cc.py')
    parser.add_argument('--checkpoint', help='checkpoint file',
                        default='<local-path>/point_code/mmdetection3d-main-nus/result/baseline+A+B/epoch_best.pth')
    parser.add_argument(
        '--work-dir',
